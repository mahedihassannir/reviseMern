        ...
        <div className='text-[#0A1727]'>
            <div>
                ...
                <div className='bg-white p-2 md:p-3 rounded flex items-center justify-between '>
                    <h3 className='text-2xl font-bold'>total: {wishList?.result?.length} reviews</h3>
                ...
                <div className='mt-4 bg-white rounded px-3 overflow-x-auto'>
                    <div className='min-w-[900px]'>
                        <table className='text-[11px]  w-full'>
                            {
                                wishList?.result?.map(res => <tbody key={res._id} className=' border-2   font-bold'>
                                    <tr className=' '>
                                        ...
                                        <td className=' w-[20%] flex-col items-start'>
                                            ...
                                            <p className='text-gray-500'>
                                                <span className='text-red-500'>updatedAt</span>:<br />    {res?.updatedAt}
                                            </p>
